...
se.RigidBodyMatter.prototype.setVelocity=function(a,b){Matter.Body.setVelocity(this.body,{x:a,y:b})};se.Scene=function(a,b){this.parent=a;this.camera=new se.GameObject("MainCamera",0,0,0,0);this.camera.setParent(this);this.pivot=new se.Transform(this,0,0);this.objs=[this.camera];this.backcolor=b||"rgba(135, 206, 250,1)";this.gravity={x:0,y:1,scale:.003};this.matterengine=Matter.Engine.create(this.parent.element);Matter.Engine.run(this.matterengine)};se.Scene.prototype.getWidth=function(){return this.parent.getWidth()};se.Scene.prototype.getHeight=function(){return this.parent.getHeight()};
