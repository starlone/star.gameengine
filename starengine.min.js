var se={};"undefined"!==typeof window&&(window.requestAnimationFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(function(){a(new Date.now)},1E3/60)}}(),window.cancelAnimationFrame=window.cancelAnimationFrame||window.mozCancelAnimationFrame);se.CircleRigidBodyMatter=function(a){this.options=a};se.CircleRigidBodyMatter.prototype.createBody=function(){var a=this.parent,b=a.transform.position;options=this.options||{};var c=options.x||b.x,b=options.y||b.y,d=options.radius||radius;delete options.x;delete options.y;delete options.radius;options.isStatic=a.isStatic;options.canRotate=a.canRotate;this.body=Matter.Bodies.circle(c,b,d,options)};
se.CircleRigidBodyMatter.prototype.update=function(a){a=this.parent.transform.position;a.x=this.body.position.x;a.y=this.body.position.y;this.parent.angle=this.body.angle};se.CircleRigidBodyMatter.prototype.setParent=function(a){this.parent=a;this.createBody()};se.CircleRigidBodyMatter.prototype.setVelocity=function(a){Matter.Body.setVelocity(this.body,a)};se.CircleRigidBodyMatter.prototype.applyForce=function(a,b){Matter.Body.applyForce(this.body,a,b)};
se.CircleRigidBodyMatter.prototype.setAngularVelocity=function(a){Matter.Body.setAngularVelocity(this.body,a)};se.BoxCollider=function(a,b,c,d){this.x=a;this.y=b;this.width=c;this.height=d};se.BoxCollider.prototype.setParent=function(a){this.parent=a};se.BoxCollider.prototype.getExtent=function(){var a=this.parent,b=a.getX()+this.x,a=a.getY()+this.y;return new se.Extent(b,a,b+this.width,a+this.height)};se.BoxCollider.prototype.isIntersect=function(a){if(a instanceof Array)for(var b in a){if(this._isIntersect(a[b]))return!0}else return this._isIntersect(a);return!1};
...
se.KeyboardHandler.prototype.keyup=function(a){"65"==a||"68"==a||"37"==a||"39"==a?this.joy.setAxis("horizontal",0):"87"==a||"83"==a?this.joy.setAxis("vertical",0):"32"==a&&this.joy.setAxis("jump",!1)};se.BoxRenderer=function(a,b,c){this.color=a;this.width=b;this.height=c};se.BoxRenderer.prototype.render=function(a){a.fillStyle=this.color;a.fillRect(-this.width/2,-this.height/2,this.width,this.height)};se.BoxRenderer.prototype.setParent=function(a){this.parent=a};se.CircleRenderer=function(a,b,c,d){this.radius=a;this.fillStyle=b;this.strokeStyle=c;this.lineWidth=d||1};
