...
se.Scene.prototype.add=function(a){this.objs.push(a);a.setParent(this)};se.Scene.prototype.update=function(a){for(var b in this.objs)this.objs[b].update(a)};se.Scene.prototype.render=function(a){this.check_move_cam(a);this.clearframe(a);this.renderBackground(a);for(var b in this.objs)this.objs[b].render(a)};se.Scene.prototype.renderBackground=function(a){a.fillStyle=this.backcolor;a.fillRect(this.camera.getX(),this.camera.getY(),this.getWidth(),this.getHeight())};
