...
se.GameObject.prototype.getColliders=function(){return this.colliders};se.GameObject.prototype.setRenderer=function(a){a.setParent(this);this.renderer=a};se.GameObject.prototype.render=function(a){var b=this.transform.position,c=this.transform.rotate;a.translate(b.x,b.y);a.rotate(c.y*Math.PI/180);a.scale(c.x,1);this.renderer&&this.renderer.render(a);for(var d in this.children)this.children[d].render(a);a.scale(c.x,1);a.rotate(-c.y*Math.PI/180);a.translate(-b.x,-b.y)};
se.GameObject.prototype.update=function(){for(var a in this.components)this.components[a].update(this);for(a in this.children)this.children[a].update()};se.GameObject.prototype.addComponent=function(a){this.components.push(a);a.setParent(this);return this};se.GameObject.prototype.addCollider=function(a){this.colliders.push(a);a.setParent(this);return this};se.GameObject.prototype.setParent=function(a){this.parent=a};se.GameObject.prototype.addChild=function(a){this.children.push(a);a.setParent(this)};
...
se.Scene.prototype.add=function(a){this.objs.push(a);a.setParent(this)};se.Scene.prototype.update=function(){for(var a in this.objs)this.objs[a].update()};se.Scene.prototype.render=function(a){this.check_move_cam(a);this.clearframe(a);this.renderBackground(a);for(var b in this.objs)this.objs[b].render(a)};se.Scene.prototype.renderBackground=function(a){a.fillStyle=this.backcolor;a.fillRect(this.camera.getX(),this.camera.getY(),this.getWidth(),this.getHeight())};
se.Scene.prototype.clearframe=function(a){a.clearRect(this.camera.getX(),this.camera.getY(),this.getWidth(),this.getHeight())};se.Scene.prototype.check_move_cam=function(a){if(this.camX!=this.camera.getX()||this.camY!=this.camera.getY()){var b=this.camX-this.camera.getX(),c=this.camY-this.camera.getY();a.translate(b,c);this.camX=this.camera.getX();this.camY=this.camera.getY()}};se.Scene.prototype.resetCamera=function(){this.camY=this.camX=0};se.BoxRenderer=function(a){this.color=a};se.BoxRenderer.prototype.render=function(a){var b=this.parent;a.fillStyle=this.color;a.fillRect(0,0,b.width,b.height)};se.BoxRenderer.prototype.setParent=function(a){this.parent=a};se.ComponentScript=function(a){this.update=a};se.ComponentScript.prototype.setParent=function(a){this.parent=a};se.ComponentPlatformPlayerController=function(a,b,c,d){this.joystick=a;this.speed=b;this.gravity=d;this.jumpspeed=c;this.jumptime=0;this.jumptimeend=25;this.isjump=!1};
se.ComponentPlatformPlayerController.prototype.update=function(a){var b=this.joystick.getAxis("horizontal")*this.speed;b&&(a.transform.move(b,0),0<b?a.transform.rotate.x=1:0>b&&(a.transform.rotate.x=-1));this.isjump?this.jumptime<this.jumptimeend?(a.transform.move(0,-1*this.jumpspeed),this.jumptime+=1):(a.transform.move(0,this.gravity),this.jumptime=0,this.isjump=!1):this.isgrounded()?this.joystick.getAxis("jump")&&(a.transform.move(0,-1*this.jumpspeed),this.isjump=!0):a.transform.move(0,this.gravity)};
se.ComponentPlatformPlayerController.prototype.isgrounded=function(){return!this.parent.transform.canMove(0,this.gravity)};se.ComponentPlatformPlayerController.prototype.setParent=function(a){this.parent=a};se.ComponentFollowPlayer=function(a){this.obj_player=a};
