...
se.KeyboardHandler.prototype.keyup=function(a){"65"==a||"68"==a||"37"==a||"39"==a?this.joy.setAxis("horizontal",0):"87"==a||"83"==a?this.joy.setAxis("vertical",0):"32"==a&&this.joy.setAxis("jump",!1)};se.Mesh=function(a){this.vertices=a||[]};se.Mesh.prototype.setVertices=function(a){this.vertices=a};se.Mesh.prototype.getVertices=function(){return this.vertices};se.Mesh.prototype.getExtent=function(){var a=this.parent.transform.getRealPosition(),b=se.Extent.createEmpty();b.extendVectors(this.vertices);return b.move(a)};se.Mesh.prototype.setParent=function(a){this.parent=a};se.RectRenderer=function(a,b,c){this.color=a;this.width=b;this.height=c};se.RectRenderer.prototype.render=function(a){a.fillStyle=this.color;a.fillRect(-this.width/2,-this.height/2,this.width,this.height)};se.RectRenderer.prototype.setParent=function(a){this.parent=a};se.CircleRenderer=function(a,b,c,d){this.radius=a;this.fillStyle=b;this.strokeStyle=c;this.lineWidth=d||1};
