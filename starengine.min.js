...
se.Scene.prototype._checkCollision=function(a,b){var c=a.getColliders(),d=b.getColliders(),e;for(e in c){var g=c[e];if(g.isIntersect(d))return new se.Collision(a,b,g.getIntersection(d))}};se.Scene.prototype._clearForces=function(a){for(var b in a){var c=a[b].rigidbody;c.force.x=0;c.force.y=0;c.torque=0}};se.Scene.prototype.render=function(a){this.updatePivot(a);this.clearframe(a);this.renderBackground(a);for(var b in this.objs)this.objs[b].render(a)};
