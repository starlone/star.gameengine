...
se.RigidBodyMatter.prototype.setParent=function(a){this.parent=a;this.createBody()};se.RigidBodyMatter.prototype.setVelocity=function(a){Matter.Body.setVelocity(this.body,a)};se.RigidBodyMatter.prototype.applyForce=function(a,b){Matter.Body.applyForce(this.body,a,b)};
