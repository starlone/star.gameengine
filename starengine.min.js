...
strokeStyle:this.strokeStyle,lineWidth:this.lineWidth}},se.RectRenderer=function(e,t,i){se.Renderer.call(this),this.color=e,this.width=t,this.height=i},se.inherit(se.Renderer,se.RectRenderer),se.RectRenderer.prototype.render=function(e){e.fillStyle=this.color,e.fillRect(-this.width/2,-this.height/2,this.width,this.height)},se.RectRenderer.prototype.json=function(){return{type:"RectRenderer",color:this.color,width:this.width,height:this.height}};