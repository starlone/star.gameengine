...
this.color;this.strokeStyle&&(a.lineWidth=this.lineWidth,a.strokeStyle=this.strokeStyle);a.fill();a.stroke()};se.RigidBody=function(a){this.options=a};se.RigidBody.prototype.createBody=function(){var a=this.parent,b=a.transform.position;options=this.options||{};var c=options.x||b.x,b=options.y||b.y;delete options.x;delete options.y;delete options.width;delete options.height;options.isStatic=a.isStatic;options.canRotate=a.canRotate;a={label:"Rectangle Body",position:{x:c,y:b},vertices:a.mesh.getVertices()};this.body=Matter.Body.create(Matter.Common.extend({},a,options))};
se.RigidBody.prototype.update=function(a){a=this.parent.transform.position;a.x=this.body.position.x;a.y=this.body.position.y;this.parent.angle=this.body.angle};se.RigidBody.prototype.setParent=function(a){this.parent=a;this.createBody()};se.RigidBody.prototype.setVelocity=function(a){Matter.Body.setVelocity(this.body,a)};se.RigidBody.prototype.applyForce=function(a,b){Matter.Body.applyForce(this.body,a,b)};
se.RigidBody.prototype.setAngularVelocity=function(a){Matter.Body.setAngularVelocity(this.body,a)};
