...
se.RigidBody.prototype.setVelocity=function(a,b){var c=new se.Vector(a,b),d=this.parent.transform.position;this.positionPrev.x=d.x-c.x;this.positionPrev.y=d.y-c.y;this.velocity.x=c.x;this.velocity.y=c.y;this.speed=this.velocity.getMagnitude()};se.RigidBody.prototype.applyForce=function(a,b,c){a=this.parent.transform.position;this.force.x+=c.x;this.force.y+=c.y;this.torque+=(b.x-a.position.x)*c.y-(b.y-a.position.y)*c.x};se.RigidBodyMatter=function(a){this.options=a};se.RigidBodyMatter.prototype.createBody=function(){var a=this.parent,b=a.transform.position;options=this.options||{};this.body=Matter.Bodies.rectangle(options.x||b.x,options.y||b.y,options.width,options.height,{isStatic:a.isStatic,canRotate:a.canRotate})};se.RigidBodyMatter.prototype.update=function(a){a=this.parent.transform.position;a.x=this.body.position.x;a.y=this.body.position.y;this.parent.angle=this.body.angle};
se.RigidBodyMatter.prototype.setParent=function(a){this.parent=a;this.createBody()};se.RigidBodyMatter.prototype.setVelocity=function(a,b){Matter.Body.setVelocity(this.body,{x:a,y:b})};se.RigidBodyMatter.prototype.applyForce=function(a,b){Matter.Body.applyForce(this.body,a,b)};
