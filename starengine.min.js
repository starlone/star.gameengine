...
se.WindowGame.prototype.init=function(){se.windowGameMain=this;animationFrame(se.updateFrame)};se.Joystick=function(){this.key=null;var a=this;this.jump=!1;$(document).keydown(function(b){a.key=b.keyCode;a.update()});$(document).keyup(function(b){a.key=null;a.reset()})};se.Joystick.prototype.update=function(){var a=this.key;"65"==a?this.x=-1:"68"==a?this.x=1:"87"==a?this.y=-1:"83"==a?this.y=1:"32"==a&&(this.jump=!0)};se.Joystick.prototype.reset=function(){this.y=this.x=0;this.jump=!1};
se.Joystick.prototype.getAxis=function(a){return"horizontal"==a?this.x:"vertical"==a?this.y:"jump"==a?this.jump:0};se.Joystick.prototype.setAxis=function(a,b){"horizontal"==a&&(this.x=b);"vertical"==a&&(this.y=b);"jump"==a&&(this.jump=b)};se.Joystick.prototype.resetAxis=function(a,b){this.y=this.x=0;this.jump=!1};se.BoxCollider=function(a,b,c,d){this.x=a;this.y=b;this.width=c;this.height=d};se.BoxCollider.prototype.setParent=function(a){this.parent=a};se.BoxCollider.prototype.getPoints=function(){var a=this.parent,b=a.getX()+this.x,a=a.getY()+this.y,c=this.width,d=this.height,e=[];e.push([b,a]);e.push([b+c,a]);e.push([b,a+d]);e.push([b+c,a+d]);return e};
