...
se.BoxCollider.prototype.isIntersect=function(a){if(a instanceof Array)for(var b in a){if(this._isIntersect(a[b]))return!0}else return this._isIntersect(a);return!1};se.BoxCollider.prototype._isIntersect=function(a){var b=this.getPoints(),c=a.getPoints();a=c[0];var c=c[3],d;for(d in b)if(b[d][0]>a[0]&&b[d][0]<c[0]&&b[d][1]>a[1]&&b[d][1]<c[1])return!0;return!1};se.BoxCollider.prototype.clone=function(){return new se.BoxCollider(this.x,this.y,this.width,this.height)};se.Scene=function(a){this.camera=new se.GameObject("MainCamera",0,0,0,0);this.camera.setParent(this);this.lastPosition=this.camera.transform.position.clone();this.camY=this.camX=0;this.objs=[this.camera];this.backcolor="rgba(135, 206, 250,1)";a&&(this.backcolor=a)};se.Scene.prototype.getWidth=function(){return this.parent.getWidth()};se.Scene.prototype.getHeight=function(){return this.parent.getHeight()};se.Scene.prototype.getCamera=function(){return this.camera};se.Scene.prototype.getObjs=function(){return this.objs};
se.Scene.prototype.setParent=function(a){this.parent=a};se.Scene.prototype.add=function(a){this.objs.push(a);a.setParent(this)};se.Scene.prototype.update=function(a){for(var b in this.objs)this.objs[b].update(a)};se.Scene.prototype.render=function(a){this.check_move_cam(a);this.clearframe(a);this.renderBackground(a);for(var b in this.objs)this.objs[b].render(a)};
se.Scene.prototype.renderBackground=function(a){a.fillStyle=this.backcolor;a.fillRect(this.camera.getX(),this.camera.getY(),this.getWidth(),this.getHeight())};se.Scene.prototype.clearframe=function(a){a.clearRect(this.camera.getX(),this.camera.getY(),this.getWidth(),this.getHeight())};
se.Scene.prototype.check_move_cam=function(a){var b=this.camera.transform.position;this.lastPosition.equals(b)||(a.translate(this.lastPosition.x-b.x,this.lastPosition.y-b.y),this.lastPosition.x=b.x,this.lastPosition.y=b.y)};se.Scene.prototype.resetCamera=function(){this.lastPosition=new se.Position(0,0)};se.BoxRenderer=function(a){this.color=a};se.BoxRenderer.prototype.render=function(a){var b=this.parent;a.fillStyle=this.color;a.fillRect(0,0,b.width,b.height)};se.BoxRenderer.prototype.setParent=function(a){this.parent=a};se.ComponentScript=function(a){this.update=a};se.ComponentScript.prototype.setParent=function(a){this.parent=a};se.ComponentPlatformPlayerController=function(a,b,c,d){this.joystick=a;this.speed=b;this.gravity=d;this.jumpspeed=c;this.jumptime=0;this.jumptimeend=25;this.isjump=!1;this.maxH=200};
...
b)};se.ComponentPlatformPlayerController.prototype.isgrounded=function(){return!this.parent.transform.canMove(0,this.gravity*this.deltaTime)};se.ComponentPlatformPlayerController.prototype.setParent=function(a){this.parent=a};se.ComponentFollowPlayer=function(a){this.obj_player=a};
