...
se.Scene.prototype.setParent=function(a){this.parent=a};se.Scene.prototype.add=function(a){this.objs.push(a);a.setParent(this)};se.Scene.prototype.update=function(a){this._applyGravity(this.objs,this.gravity);for(var b in this.objs){var c=this.objs[b];c.update(a);c.rigidbody.update(a)}this._resolveColliders(this.objs)};
se.Scene.prototype._applyGravity=function(a,b){var c="undefined"!==typeof b.scale?b.scale:.001;if((0!==b.x||0!==b.y)&&0!==c)for(var d in a){var e=a[d];e.isStatic||e.isSleeping||(e=e.rigidbody,e.force.y+=e.mass*b.y*c,e.force.x+=e.mass*b.x*c)}};se.Scene.prototype._resolveColliders=function(a){for(var b=[],c=0;c<a.length;c++){var d=a[c];if(!d.isStatic&&!d.isSleeping)for(var e=0;e<a.length;e++)if(c!=e){var f=this._checkCollision(d,a[e]);f&&b.push(f)}}for(c in b);};
se.Scene.prototype._checkCollision=function(a,b){var c=a.getColliders(),d=b.getColliders(),e;for(e in c)if(c[e].isIntersect(d))return console.log(a,b),new se.Collision(a,b)};se.Scene.prototype.render=function(a){this.updatePivot(a);this.clearframe(a);this.renderBackground(a);for(var b in this.objs)this.objs[b].render(a)};se.Scene.prototype.renderBackground=function(a){a.fillStyle=this.backcolor;a.fillRect(this.pivot.position.x,this.pivot.position.y,this.getWidth(),this.getHeight())};
