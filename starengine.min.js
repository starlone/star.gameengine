...
se.KeyboardHandler.prototype.keyup=function(a){"65"==a||"68"==a?this.joy.setAxis("horizontal",0):"87"==a||"83"==a?this.joy.setAxis("vertical",0):"32"==a&&this.joy.setAxis("jump",!1)};se.ComponentScript=function(a){this.update=a};se.ComponentScript.prototype.setParent=function(a){this.parent=a};se.ComponentPlayerController=function(a,b,c,d){this.joystick=a;this.speed=b;this.gravity=d;this.jumpspeed=c;this.jumptime=0;this.jumptimeend=25;this.isjump=!1};
se.ComponentPlayerController.prototype.update=function(a){var b=this.joystick.getAxis("horizontal")*this.speed;b&&(a.transform.move(b,0),0<b?a.transform.rotate.x=1:0>b&&(a.transform.rotate.x=-1));this.isjump?this.jumptime<this.jumptimeend?(a.transform.move(0,-1*this.jumpspeed),this.jumptime+=1):(a.transform.move(0,this.gravity),this.jumptime=0,this.isjump=!1):this.isgrounded()?this.joystick.getAxis("jump")&&(a.transform.move(0,-1*this.jumpspeed),this.isjump=!0):a.transform.move(0,this.gravity)};
