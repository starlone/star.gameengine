...
se.MeshRenderer.prototype.render=function(a){var b=this.parent.mesh;a.beginPath();a.moveTo(b.vertices[0].x,b.vertices[0]);for(var c=1;c<b.vertices.length;c++)a.lineTo(b.vertices[c].x,b.vertices[c].y);a.lineTo(b.vertices[0].x,b.vertices[0].y);a.closePath();a.fillStyle=this.color;this.strokeStyle&&(a.lineWidth=this.lineWidth,a.strokeStyle=this.strokeStyle);a.fill();a.stroke()};se.RigidBody=function(a){this.options=a};se.RigidBody.prototype.createBody=function(){var a=this.parent,b=a.transform.position,c=this.options||{},d=c.x||b.x,b=c.y||b.y;this.isPermeable=null!=c.isPermeable?c.isPermeable:!1;null==c.canRotate&&(c.canRotate=!0);delete c.x;delete c.y;delete c.isPermeable;a={label:"Rectangle Body",position:{x:d,y:b},vertices:a.mesh.getVertices()};this.body=Matter.Body.create(Matter.Common.extend({},a,c))};
