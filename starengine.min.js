...
se.RectCollider.prototype._getIntersection=function(a){var b=this.getExtent();a=a.getExtent();return b.getIntersection(a)};se.RectCollider.prototype.resolveCollision=function(a){this.parent.resolveCollision(a)};se.RectCollider.prototype.clone=function(){return new se.RectCollider(this.x,this.y,this.width,this.height)};se.ComponentScript=function(a,b){this.update=a;this.resolveCollision=b};se.ComponentScript.prototype.setParent=function(a){this.parent=a};se.ComponentPlatformPlayerController=function(a,b,c){this.joystick=a;this.speed=b||.5;this.jumpspeed=c||-13};
