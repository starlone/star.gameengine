...
se.KeyboardHandler.prototype.keyup=function(a){"65"==a||"68"==a||"37"==a||"39"==a?this.joy.setAxis("horizontal",0):"87"==a||"83"==a?this.joy.setAxis("vertical",0):"32"==a&&this.joy.setAxis("jump",!1)};se.BoxRenderer=function(a){this.color=a};se.BoxRenderer.prototype.render=function(a){var b=this.parent;a.fillStyle=this.color;a.fillRect(0,0,b.width,b.height)};se.BoxRenderer.prototype.setParent=function(a){this.parent=a};se.ImageRenderer=function(a){this.img=new Image;this.is_load=!1;this.img.src=a};se.ImageRenderer.prototype.render=function(a){var b=this.parent;a.drawImage(this.img,0,0,b.width,b.height)};se.ImageRenderer.prototype.setParent=function(a){this.parent=a};se.Scene=function(a,b){this.camera=new se.GameObject("MainCamera",0,0,0,0);this.camera.setParent(this);this.pivot=new se.Transform(this,0,0);this.objs=[this.camera];this.backcolor=a||"rgba(135, 206, 250,1)";this.gravityScale=b||.001};se.Scene.prototype.getWidth=function(){return this.parent.getWidth()};se.Scene.prototype.getHeight=function(){return this.parent.getHeight()};se.Scene.prototype.getCamera=function(){return this.camera};se.Scene.prototype.getObjs=function(){return this.objs};
se.Scene.prototype.setParent=function(a){this.parent=a};se.Scene.prototype.add=function(a){this.objs.push(a);a.setParent(this)};se.Scene.prototype.update=function(a){for(var b in this.objs){var c=this.objs[b];this._applyGravity(c,a);c.update(a);c.rigidbody.update(a)}};se.Scene.prototype._applyGravity=function(a,b){if(!a.isStatic){var c=a.rigidbody;c.force.y+=c.mass*this.gravityScale}};se.Scene.prototype.render=function(a){this.updatePivot(a);this.clearframe(a);this.renderBackground(a);for(var b in this.objs)this.objs[b].render(a)};
