...
se.GameObject.prototype.destroy=function(){this.parent instanceof se.GameObject&&this.parent.removeChild(this);this.getScene().remove(this)};se.GameObject.prototype.setMesh=function(a){this.mesh=a;a.setParent(this)};se.Transform=function(a,b,c){this.parent=a;this.position=new se.Vector(b,c);this.rotate=new se.Vector(1,0)};se.Transform.prototype.change=function(a,b){this.position.change(a,b)};se.Transform.prototype.move=function(a,b){this.position.x+=a;this.position.y+=b};
...
se.KeyboardHandler.prototype.keyup=function(a){"65"==a||"68"==a||"37"==a||"39"==a?this.joy.setAxis("horizontal",0):"87"==a||"83"==a?this.joy.setAxis("vertical",0):"32"==a&&this.joy.setAxis("jump",!1)};se.Mesh=function(a){this.vertices=a||[]};se.Mesh.prototype.setVertices=function(a){this.vertices=a};se.Mesh.prototype.getVertices=function(){return this.vertices};se.Mesh.prototype.getExtent=function(){var a=se.Extent.createEmpty();a.extendVectors(this.vertices);return a};se.Mesh.prototype.setParent=function(a){this.parent=a};se.RectRenderer=function(a,b,c){this.color=a;this.width=b;this.height=c};se.RectRenderer.prototype.render=function(a){a.fillStyle=this.color;a.fillRect(-this.width/2,-this.height/2,this.width,this.height)};se.RectRenderer.prototype.setParent=function(a){this.parent=a};se.CircleRenderer=function(a,b,c,d){this.radius=a;this.fillStyle=b;this.strokeStyle=c;this.lineWidth=d||1};
...
this.color;this.strokeStyle&&(a.lineWidth=this.lineWidth,a.strokeStyle=this.strokeStyle);a.fill();a.stroke()};se.RigidBody=function(a){this.options=a};se.RigidBody.prototype.createBody=function(){var a=this.parent,b=a.transform.position,c=this.options||{},d=c.x||b.x,b=c.y||b.y;this.isPermeable=null!=c.isPermeable?c.isPermeable:!1;null==c.canRotate&&(c.canRotate=!0);delete c.x;delete c.y;delete c.isPermeable;a={label:"Rectangle Body",position:{x:d,y:b},vertices:a.mesh.getVertices()};this.body=Matter.Body.create(Matter.Common.extend({},a,c))};
